...
public class Panel extends JPanel {
    ...
    boolean dragging2, dragging3, dragging5  = false;
    ...
    public void NewCursor (int i) {     //alterna entre os tipos de cursores dependendo de onde o mouse é posicionado
        if (i == 1) {
